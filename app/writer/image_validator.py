    ...
    async def does_image_match(
        ...
        *,
        ...
        prompt = (
            ...
            "sidelines, equipment); both are acceptable IF they actually depict "
            "football content AND don't misrepresent the story's current context.\n\n"
            ...
            "Before considering anything else, ask: does the image visibly "
            "depict NFL / American football subject matter?\n"
            "Valid on-topic subjects include: football players in uniform or "
            "practice gear, coaches in team gear on a sideline, a football "
            "field with yard lines and goal posts, a football stadium "
            "(interior or exterior), a football itself, a helmet or shoulder "
            "pads, a locker room, an NFL press conference, an NFL draft or "
            "front-office setting, an athletic training room, a referee in "
            "striped uniform, or a clear scene of football practice / drills.\n"
            "REJECT immediately (matches=false, reason starts with 'off-topic:') "
            "if the image shows any of the following and no football subject "
            "is visible: wildlife / animals / nature scenes, landscapes with no "
            "stadium, random people not in football context, other sports, "
            "cityscapes, interiors unrelated to football, vehicles, food, "
            "abstract art that is not a football-color pattern, diagrams or "
            "maps, book covers, movie posters, or any subject a reader would "
            "describe as 'not about football at all.' Uniform colors alone are "
            "NOT football evidence — red jerseys without football context could "
            "be anything. Require actual football cues (ball, pads, field, "
            "stadium, helmet, scoreboard, goalpost, sideline, end zone, pylons, "
            "training-room table, press podium with NFL context, etc.).\n\n"
            "=== GATE 2 — If Gate 1 passed, apply these rejections ===\n"
            "- Different sport: clearly baseball, basketball, soccer, hockey, etc.\n"
            "- Different-team contradiction: image clearly shows another "
            ...
            "  with a plain backdrop: these do not work as news lead images. "
            "  We want action / sideline / practice / locker / press / "
            "  front-office / stadium / equipment scenes — NOT a posed "
            "  one-person portrait against a studio or draped background.\n"
            "- Obviously dated: heavily yellowed, visible film grain, uniform "
            "  styling from clearly decades ago, or a historical-archive look "
            "  when the story is about current events.\n"
            "- Low quality: obviously amateur, blurry to distraction, cropped "
            "  or compressed badly, watermarked from a consumer stock site, "
            "  meme / cartoon / clip-art / 3D render, screenshot, infographic, "
            "  or stats card.\n"
            "- Offensive or clearly broken / corrupted.\n\n"
            "=== GATE 3 — If Gate 2 didn't reject, accept only when ===\n"
            ...
            "  interior, grass / field, goalposts, unbranded equipment, crowd "
            "  shot) that doesn't contradict the expected team, OR\n"
            "- The image is an editorial mood shot with clear football setting "
            "  (empty stadium at dusk, silhouette on a football field, "
            "  team-color abstract with visible football cue) that fits the "
            "  story and doesn't display a contradicting team's marks.\n\n"
            "Doubt handling:\n"
            "- Topic-relevance doubt ('is this actually football?') → prefer REJECT.\n"
            "- Portrait / dated / low-quality / wrong-sport doubt → prefer REJECT.\n"
            "- Team-identity ambiguity (can't tell which team, no marks "
            "  visible, but clearly football) → prefer ACCEPT if the scene is "
            "  otherwise news-appropriate.\n"
