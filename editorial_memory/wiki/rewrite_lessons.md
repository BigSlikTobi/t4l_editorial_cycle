...
- Do not treat an unsupported digest or mismatched source title/URL as proof of specific details.
...
- [insider] Cut meta phrasing like 'report points to' or 'expected to be available' unless the package directly supports it.
...
- [insider] Do not make unsupported 'on track' or 'trending toward the lineup' claims when the digest is effectively empty; that is not recoverable in rewrite.
