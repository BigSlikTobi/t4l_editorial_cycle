...
- [insider] Don’t add roster-impact or role conclusions unless the source explicitly supports them.
...
- (source-side, not fixable in prose) Don’t treat plausible-sounding story angles as support when the digest has no usable facts; a closed-world piece needs verifiable source material.
- (source-side, not fixable in prose) Don’t leave fabricated names, team moves, or aftermath details in place on a rewrite; if they aren’t in the digest, remove them entirely.
