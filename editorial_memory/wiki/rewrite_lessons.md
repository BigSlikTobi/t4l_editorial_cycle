...
- Lead with the single clearest verified or well-attributed move when the source is thin; a direct update is stronger than trying to broaden it.
- Keep the lede/headline package tightly aligned to the reported development so the first read lands on the actual news.
...
- Keep supporting context subordinate to the main development; it should clarify, not compete.
