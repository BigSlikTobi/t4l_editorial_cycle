...
- Lead with the verified status change or report immediately; make the first sentence carry the story.
...
- [insider] When the status change is the news, a simple camp-availability angle can be stronger than trying to over-explain the background.
