...
- Use specific, sourced facts as the anchor instead of broad roster-planning, role language, or abstract “meaning.”
...
- Clean, restrained execution helps a short item feel publishable even without much source material.
...
- [insider] Lead with the verified dollar-and-term facts when a contract update is fully supported; tight numbers-first framing fits the persona well.
...
- Don’t build on a title-level premise when the digest has no usable facts; that is a source-side miss, not something prose can repair (source-side, not fixable in prose).
...
- Don’t bury the main fact under side references to other named people.
...
- [insider] Don’t let report-style phrasing or vague consequence language blur a contract update that has specific dollar-and-term facts; lead with the verified numbers and stop there.
- [insider] Don’t fabricate a status change or practice/report detail from a headline alone; if the digest has no usable facts, the piece is source-side, not salvageable in prose.
