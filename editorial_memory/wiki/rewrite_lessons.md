...
- [casey whitaker] Don’t package one source story against an unrelated broader angle unless that angle is directly supported.
...
- [casey whitaker] Don’t add invented backstory or reunion-style framing when the digest only supports the quoted declaration itself.
