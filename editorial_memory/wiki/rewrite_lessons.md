...
- Keep headline and intro doing the same job so the main fact lands fast.
...
- When the core angle is legitimate, modest structure can still pass if the central fact is unmistakable.
...
- Don’t lean on generic setup or “extra weight” language when the direct source detail is already the strongest lead.
...
- Don’t repeat the same metaphor or hook in every paragraph; it makes a thin piece feel thinner.
- Don’t build the story around unsupported framing that is not doing any real work for the reader.
- Don’t turn a simple announcement or matchup into a bigger narrative than the reporting justifies.
- Don’t use meta language that signals thinness instead of adding substance.
