...
- When source material is thin, a narrow, fact-true angle can work better than an ambitious frame.
...
- A concise opening that stays faithful to the source can be stronger than trying to manufacture added context.
...
- Do not introduce unsupported future plans, timetables, or team-field details when the source only gives a headline-level premise.
- Avoid a dry, repetitive lede that restates the headline without adding any verified substance.
