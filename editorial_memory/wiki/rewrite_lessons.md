...
- Open with the confirmed takeaway and stay tightly inside the source.
- Lead with the concrete update first; let the verified fact carry the piece.
- Keep headline and lede aligned on the same sourced development, with no near-verbatim echo.
- Use restrained, source-faithful tone when the source supports only a narrow fact.
...
- Keep roundup or digest framing factual and specific to the names actually supported by the source.
- When the source includes a clear takeaway plus uncertainty, preserve both rather than forcing a stronger conclusion.
...
- [analyst] If the digest is effectively empty, cut any extra claims about decision-making, timelines, or team statements; stay with the report itself.
