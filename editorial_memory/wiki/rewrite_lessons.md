...
- Keep the story tightly inside the source digest when the facts are limited; a focused, source-faithful take can still read well.
...
- A clear team-specific hook can come from one quote plus one concrete, source-backed trigger.
