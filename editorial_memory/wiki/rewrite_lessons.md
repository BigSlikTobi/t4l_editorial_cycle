...
- Keep headline and lede aligned on the same verified update, with no near-verbatim echo.
...
- When the source supports it, sharpen the intro around why the update matters to readers, not just the bare announcement.
- A concise note can work if it centers the confirmed update and avoids overbuilding around it.
- [columnist] A modest, concrete angle can be enough when it is fully grounded and the headline, intro, and body stay aligned.
