...
- Lead with the verified core fact when the source is thin; a clean, simple lede can carry the piece.
- Keep the headline and intro locked to the same confirmed claim without drift.
- Let the confirmed fact do the work instead of adding commentary about how the story was reported or why it matters.
- Stay grounded and restrained; factual phrasing reads better than meta explanations about the source.
- Use only source-supported context details, and keep them secondary to the core update.
...
- Don’t write around the lack of context; strip out commentary about what the digest does not provide and stay with the fact you can verify.
