...
- When a rewrite is saved, keep the fix: add only the missing verified fact(s), not new framing.
...
- Do not overbuild an injury/recovery update beyond the confirmed timeline, injury details, and role note.
